      ...
      return regeneratorRuntime.async(function createTables$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(_DB["default"].query(dropGifCommentTable));

            case 2:
              _context.next = 4;
              return regeneratorRuntime.awrap(_DB["default"].query(dropArticleCommentTable));

            case 4:
              _context.next = 6;
              return regeneratorRuntime.awrap(_DB["default"].query(dropgifsTable));

            case 6:
              _context.next = 8;
              return regeneratorRuntime.awrap(_DB["default"].query(dropArticleTable));

            case 8:
              _context.next = 10;
              return regeneratorRuntime.awrap(_DB["default"].query(dropEmpTable));

            case 10:
              _context.next = 12;
              return regeneratorRuntime.awrap(_DB["default"].query(employeTable));

            case 12:
              _context.next = 14;
              return regeneratorRuntime.awrap(_DB["default"].query(gifTable));

            case 14:
              _context.next = 16;
              return regeneratorRuntime.awrap(_DB["default"].query(articleTable));

            case 16:
              _context.next = 18;
              return regeneratorRuntime.awrap(_DB["default"].query(commentArticleTable));

            case 18:
              _context.next = 20;
              return regeneratorRuntime.awrap(_DB["default"].query(gifCommentTable));
